...
<body>
    <div class="landing">
        <header id="header">
            ...
            <nav id="nav">
                <ul>
                    <li><a href="select_course.php">選課</a></li>
            ...
            <div class="inner">
                ...
                <div class="thumbnails">
                    ...
                    <div class="box">
                        ...
                        <div class="inner">
                            <h3 style="color:white">Nascetur nunc varius commodo</h3>
                            <p style="color:white">Interdum amet accumsan placerat commodo ut amet aliquam blandit nunc tempor lobortis nunc non. Mi accumsan.</p>
                            <a href="https://youtu.be/s6zR2T9vn2c" class="button fit" data-poptrox="youtube,800x400">查看</a>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        ...
                        <div class="inner">
                            <h3 style="color:white">Nascetur nunc varius commodo</h3>
                            <p style="color:white">Interdum amet accumsan placerat commodo ut amet aliquam blandit nunc tempor lobortis nunc non. Mi accumsan.</p>
                            <a href="https://youtu.be/s6zR2T9vn2c" class="button style2 fit" data-poptrox="youtube,800x400">查看</a>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        ...
                        <div class="inner">
                            <h3 style="color:white">Nascetur nunc varius commodo</h3>
                            <p style="color:white">Interdum amet accumsan placerat commodo ut amet aliquam blandit nunc tempor lobortis nunc non. Mi accumsan.</p>
                            <a href="https://youtu.be/s6zR2T9vn2c" class="button style3 fit" data-poptrox="youtube,800x400">查看</a>
                        </div>
                    </div>
