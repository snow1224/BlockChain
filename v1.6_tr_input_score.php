...
//
function show_subunit_table($get_unit_course_id,$get_unit_course_hours){
    echo '<div id="main_N_unit_response_stu" aria-labelledby="main_N_unit_response_stu" class="collapse">';
        echo '<div class="tabItemContainer">';
            for($i=1 ; $i<=$get_unit_course_hours ; $i+=1){
                    echo '<li><a>第'.$get_unit_course_hours.'堂課</a></li>';
            }
        echo '</div>';
...
//
function show_unit_table ($get_unit_course_id,$get_unit_course_hours){
