            ...
            <ul class="nav navbar-nav navbar-right">
                      ...
                      <?php
                        if(isset($_SESSION["login"]) && $_SESSION["login"]==1){
                           ...
                           echo '<li><a href="./v1.5_tr_open_course.php"><span class="glyphicon glyphicon-shopping-cart"> 開課申請</a></li>';
                        }else{
                           echo '<li><a href="#"><span class="glyphicon glyphicon-star"></span> 我的最愛</a></li>';
                           echo '<li><a href="./index.php"><span class="glyphicon glyphicon-shopping-cart"></span> 選課</a></li>';
...
//        echo $main_N_unit_response[$N_unit]["hours"];

        echo '<div id="'.$main_N_unit_response[$N_unit]["unit_course_id"].'table"  aria-labelledby="'.$main_N_unit_response[$N_unit]["unit_course_id"].'table" class="collapse"  >';
        //            把unit id 還有空的$all_stu_id陣列傳過去
...
function show_unit_table ($get_unit_course_id,$unit_hours){
        global $after_hours;
...
//    echo '<form name="tr_send_point" method="post" action="./v1.2_tr_input_score_system.php">';
    ...
    echo '<div class="tabItemContainer">';
            for ($i=1 ; $i <= $unit_hours ; $i++)
                echo '<li><a id="'.($after_hours+$i-1).' '.$get_unit_course_id.'">第'.$i.'堂課</a></li>';
//            echo '<li><a>第二堂課</a></li>';
//            echo '<li><a>第三堂課</a></li>';
        echo '</div>';
    for ($i=1 ; $i <= $unit_hours ; $i++){
...
//        echo $_SESSION["course"][$get_unit_course_id][$n]=$stu[1];
                if($get_unit_course_id_response[$n]["attend_status"] == "ATTEND"){
                    echo '<input type="radio" name="attend' .$unit_and_stu_id.'_'.$i. '" value="attend" checked="True">出席';
                    echo '<input type="radio" name="attend' .$unit_and_stu_id.'_'.$i. '" value="unattend">未出席';
                }
                else{
                    echo '<input type="radio" name="attend' .$unit_and_stu_id.'_'.$i. '" value="attend" >出席';
                    echo '<input type="radio" name="attend' .$unit_and_stu_id.'_'.$i. '" value="unattend" checked="True">未出席';
